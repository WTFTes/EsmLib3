...
public class Door : AbstractRecord
{
    public override RecordName Name => RecordName.DOOR;
    ...
    public RefId mOpenSound { get; set; }
    
    public RefId mCloseSound { get; set; }
        ...
        while (reader.HasMoreSubs)
        {
            ...
            switch (reader.retSubName())
            {
                ...
                case RecordName.SNAM:
                    mOpenSound = reader.getRefId();
                    break;
                case RecordName.ANAM:
                    mCloseSound = reader.getRefId();
                    break;
